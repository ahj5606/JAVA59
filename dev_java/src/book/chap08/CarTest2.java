...
public class CarTest2 {
	public static void main(String[] args) {
		...
		if(myCar instanceof Car) {
			...
			System.out.println("myCar는 Car클래스 타입이아니다.");
		}
		if(herCar instanceof Car) { //Tivol는 Car의 상속관계
			System.out.println("herCar는 Car클래스 타입입니다.");
		}else {
			System.out.println("herCar는 Car클래스 타입이아니다.");
		}
		if(herCar instanceof Tivoli) {
			System.out.println("herCar는 Tivoli클래스 타입입니다.");
		}else {
			System.out.println("herCar는 Tivoli클래스 타입이아니다.");
		}
